...
abstract class AbstractVaadinFactory extends AbstractFactory {
    ...
    @Override
    public abstract void setChild( FactoryBuilderSupport builder, Object parent, Object child )

	@Override
	public abstract void setParent(FactoryBuilderSupport builder, Object parent,Object child)
